...
const Footer = () => {
  ...
  const trades = [
    ...
    { name: "HVAC Technicians", href: "/trades/hvac" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              />
              <div>
                <div className="font-bold text-lg">True To Blue</div>
                <div className="text-sm text-slate-400">Professional Solutions</div>
              </div>
            </div>
            <p className="text-slate-400 text-sm mb-4">
              Smart voice solutions and automated systems built specifically for trade professionals. 
              Never miss another call and spend more quality time with your family.
            </p>
        ...
        <div className="border-t border-slate-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">
              © {currentYear} True To Blue. Built for hardworking trade professionals.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/sitemap.xml" className="text-slate-400 hover:text-white text-sm transition-colors">
                Sitemap
              </Link>
            </div>
          </div>
